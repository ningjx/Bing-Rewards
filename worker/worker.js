...
//  { name: "baidu", url: `https://api.gmya.net/Api/BaiduHot?format=json&appkey=${env.GMYA_KEY}`, keyword: "title" },
  { name: "baidu", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': '百度'}, keyword: "title" },
...
//  { name: "douyin", url: `https://api.gmya.net/Api/DouYinHot?format=json&appkey=${env.GMYA_KEY}`, keyword: "title" },
  { name: "douyin", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': '抖音'}, keyword: "title" },
...
//  { name: "toutiao", url: `https://api.gmya.net/Api/TouTiaoHot?format=json&appkey=${env.GMYA_KEY}`, keyword: "title" },
  { name: "toutiao", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': '今日头条'}, keyword: "title" },
...
//  { name: "weibo", url: `https://api.gmya.net/Api/WeiBoHot?format=json&appkey=${env.GMYA_KEY}`, keyword: "title" },
  { name: "weibo", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': '微博'}, keyword: "title" },
...
//  { name: "zhihu", url: `https://api.gmya.net/Api/ZhiHuHot?format=json&appkey=${env.GMYA_KEY}`, keyword: "title" },
  { name: "zhihu", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': '知乎'}, keyword: "title" },
...
//  { name: "bilibili", url: `https://api.gmya.net/Api/BiliBliHot?format=json&appkey=${env.GMYA_KEY}`, keyword: "title" },
  { name: "bilibili", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': '哔哩哔哩'}, keyword: "title" },
...
//  { name: "sougou", url: `https://api.gmya.net/Api/SoGouHot?format=json&appkey=${env.GMYA_KEY}`, keyword: "title" },
  { name: "tieba", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': '百度贴吧'}, keyword: "title" },
  { name: "ithome", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': 'IT之家'}, keyword: "title" },
//  { name: "jianshu", url: "https://api.pearktrue.cn/api/dailyhot/", headers: {'title': '简书'}, keyword: "title" },
